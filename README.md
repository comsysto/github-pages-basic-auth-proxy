...
<p align="center">
  ...
  * During the install you need to specify `Repository-Owner`, `Repository-Name` and `Obfuscator`. <br>&nbsp;
  * You will also need to specify the  `authType` which can be:
    * `onlyGitHubOrgUsers` which will allow every GitHub user belonging to your GitHub Organization 
      * Note: repository must be an org repo
...
<p align="center">
  <img src="https://comsysto.github.io/github-pages-basic-auth-proxy/public/heroku-deploy-success.png"  width="60%" />
</p>

  * When you configured the parameters correctly you should see a page like this <br>&nbsp;

<p align="center">
  <img src="https://comsysto.github.io/github-pages-basic-auth-proxy/public/heroku-install-success.png"  width="80%" />
</p>
